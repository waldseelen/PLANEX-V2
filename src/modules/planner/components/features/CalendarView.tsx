...
/**
 * CalendarView — the month grid + today/upcoming-exam cards + event modal,
 * extracted from the old standalone CalendarPage so it can be embedded as a
 * view tab inside PersonalTasksPage (Görev+Takvim unification). No page-level
 * header of its own — the host page provides that.
 */
                    ...
                    <Card>
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <Button size="sm" onClick={() => openCreateModal(todayISO, 'event')} leftIcon={<Plus className="w-3.5 h-3.5" />}>
